...
package.domain = org.securemessenger
...
requirements = python3,kivy==2.2.1,kivymd==1.1.1,requests,pillow,python-dotenv,cryptography,bcrypt
...
android.presplash_color = #0E1621
